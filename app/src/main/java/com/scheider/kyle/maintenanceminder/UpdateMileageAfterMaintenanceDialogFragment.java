...
public class UpdateMileageAfterMaintenanceDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        final View myView = inflater.inflate(R.layout.update_mileage_dialog, null);
        ...
        builder.setView(myView)
                ...
                .setPositiveButton("Update", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if (mListener != null) {
                            newMileage = String.valueOf(newMileageEditText.getText());
                            cost = String.valueOf(costEditText.getText());
                        ...
                        if (validMileage) {
                            mListener.updateMileageOnCLick(UpdateMileageAfterMaintenanceDialogFragment.this, newMileage, cost);
                        }
                    }
                });
